    ...
    // يمكنك هنا إظهار رسالة خطأ للمستخدم
          ...
          {activeSection === "introduction" && (
            <div className="space-y-8">
              <Card className="bg-[#1E1E1E] border-[#333333]">
                <CardHeader>
                  <CardTitle>Introduction to Krkrai Platform</CardTitle>
                  <CardDescription>
                    A brief overview of the Krkrai platform and its core functionalities.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">
                    The Krkrai Platform is an advanced AI-driven ecosystem designed to empower users with cutting-edge
                    artificial intelligence capabilities. It integrates various AI models, robust data analytics, and a
                    seamless user experience to provide comprehensive solutions for a wide range of applications.
                  </p>
                  <p className="mb-4">
                    Our platform focuses on delivering intelligent automation, deep insights from complex data, and
                    innovative tools for content generation and analysis. Whether you are a developer looking to
                    integrate powerful AI into your applications, a data scientist seeking advanced analytical tools, or
                    a business professional aiming to streamline operations, Krkrai offers the tools you need.
                  </p>
                  <p>
                    Key components include an AI-powered chat interface, a sophisticated AI training system (Wolf AI
                    Trainer), dynamic dashboards for performance monitoring, and secure API key management through the
                    KRKR system.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1E1E1E] border-[#333333]">
                <CardHeader>
                  <CardTitle>Wolf AI Trainer</CardTitle>
                  <CardDescription>Detailed guide on using and configuring the Wolf AI Trainer.</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">
                    The Wolf AI Trainer is the core of our platform's AI model management. It allows you to train,
                    validate, and deploy custom AI models with ease. The trainer is designed for high performance and
                    scalability, leveraging advanced algorithms and robust infrastructure.
                  </p>
                  <h3 className="text-xl font-semibold mb-2">Training Process</h3>
                  <p className="mb-4">
                    The training process involves several stages: data ingestion, model initialization, iterative
                    training epochs, checkpointing, and final model validation. The trainer automatically handles data
                    loading from Supabase, initializes base models, and saves training progress.
                  </p>
                  <h3 className="text-xl font-semibold mb-2">Configuration</h3>
                  <p className="mb-4">
                    Configuration parameters for the Wolf AI Trainer can be found in `lib/wolf-ai-trainer.ts`. These
                    include model names, base models, training versions, and hyper-parameters such as learning rate,
                    batch size, and epochs. You can customize these settings to optimize your model's performance.
                  </p>
                  <h3 className="text-xl font-semibold mb-2">KRKR Key Integration</h3>
                  <p>
                    The Wolf AI Trainer integrates seamlessly with the KRKR Key System for secure API key generation and
                    management. Each trained model can have a unique KRKR key with defined permissions and usage limits,
                    ensuring secure access to your AI services.
                  </p>
                </CardContent>
              </Card>
            </div>
